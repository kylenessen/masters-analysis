...
- Deployment random effect: `s(deployment_id, bs="re")`
...
Models named: `m[complexity]_[version]`
- Complexity: `null`, `temp`, `wind`, `sun`, `additive`, `interact`, `full`
- Version: `smooth` or `linear` (for baseline/lag functional form)
