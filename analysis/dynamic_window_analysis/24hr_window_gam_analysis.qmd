...
fit_model_safe(
 ...
 fit_model_safe(
   "butterfly_diff_sqrt ~ s(max_butterflies_t_1, k = k_baseline) + wind_max_gust + sum_butterflies_direct_sun + wind_max_gust:sum_butterflies_direct_sun",
   "linear", "M77", "Linear interaction: wind_max_gust × sum_butterflies_direct_sun (with baseline)"
 )
 fit_model_safe(
   "butterfly_diff_sqrt ~ s(max_butterflies_t_1, k = k_baseline) + temp_min + temp_max + wind_max_gust + sum_butterflies_direct_sun + wind_max_gust:sum_butterflies_direct_sun",
   "linear", "M78", "Linear interaction + temp_min + temp_max (with baseline)"
 )
