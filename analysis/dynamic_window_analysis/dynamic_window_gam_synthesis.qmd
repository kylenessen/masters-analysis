...
To address this feedback while exploring biological relevance, I conducted two parallel analyses:
...
I evaluated three butterfly difference metrics (max, 95th percentile, and top 3 mean) with three transformations each (untransformed, square root, and square) to determine which best approximates normality for GAM modeling.
...
Based on correlation structure, biological relevance, and variance inflation considerations, I selected **5 final predictors** representing distinct aspects of weather exposure:
...
I fit **76 models** spanning a hierarchy of complexity:
...
kable(
    ...
    caption = "Top 5 Models: 24-Hour Window Analysis (ranked by AICc)"
)
```
