...
plot(best_model$gam,
    ...
    xlab = "Temperature (°C)", ylab = "Partial Effect",
    residuals = TRUE, pch = 19, cex = 0.5
)
```
...
plot(best_model$gam,
    ...
    xlab = "Time Since Sunrise (minutes)", ylab = "Partial Effect",
    residuals = TRUE, pch = 19, cex = 0.5
)
```

### Effect of Butterflies in Direct Sun (Smooth)
...
plot(best_model$gam,
    select = 4, main = "Effect of Butterflies in Direct Sun (Smooth)",
    xlab = "Butterflies in Direct Sun", ylab = "Partial Effect",
    residuals = TRUE, pch = 19, cex = 0.5
)
```
...
draw(best_model$gam, select = "s(total_butterflies_t_lag)") +
    theme_minimal() +
    labs(title = "Effect of Previous Butterfly Count")
```
...
draw(best_model$gam, select = "s(butterflies_direct_sun_t_lag)") +
    theme_minimal() +
    labs(title = "Effect of Butterflies in Direct Sun")
```
...
#### Effect of Maximum Wind Speed

```{r second-effect-wind}
#| fig-width: 10
#| fig-height: 6
plot(second_best_model$gam,
    select = 2, main = "Effect of Maximum Wind Speed (Second Best Model)",
    xlab = "Maximum Wind Speed (m/s)", ylab = "Partial Effect",
    residuals = TRUE, pch = 19, cex = 0.5
)
```
...
#### Effect of Butterflies in Direct Sun

```{r second-effect-sun}
#| fig-width: 10
#| fig-height: 6
plot(second_best_model$gam,
    select = 4, main = "Effect of Butterflies in Direct Sun (Second Best Model)",
    xlab = "Butterflies in Direct Sun", ylab = "Partial Effect",
    residuals = TRUE, pch = 19, cex = 0.5
)
```
...
#| fig-height: 6
plot(second_best_model$gam,
    select = 5, main = "Diurnal Patterns (Second Best Model)",
    xlab = "Time Since Sunrise (minutes)", ylab = "Partial Effect",
    residuals = TRUE, pch = 19, cex = 0.5
)
```
...
# Effect of Previous Butterfly Count
png(file.path(fig_dir, "effect_previous_butterfly_count.png"),
...
png(file.path(fig_dir, "effect_butterflies_direct_sun.png"),
    width = 8, height = 6, units = "in", res = 300
)
plot(best_model$gam,
    select = 3,
    main = "Effect of Butterflies in Direct Sun",
    xlab = "Butterflies in direct sun",
    ylab = "Partial effect",
...
# Diurnal Patterns
png(file.path(fig_dir, "diurnal_patterns.png"),
    width = 8, height = 6, units = "in", res = 300
)
plot(best_model$gam,
    select = 4,
    main = "Effect of Diurnal Patterns",
    xlab = "Time since sunrise (minutes)",
    ylab = "Partial effect",
