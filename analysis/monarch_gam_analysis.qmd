...
**Wind Effects:** Wind was not selected in the best-performing model and appeared only in the second-best model with a non-significant effect (p = 0.218). This suggests that wind is not a primary driver of short-term monarch movement patterns at the temporal and spatial scales examined.
