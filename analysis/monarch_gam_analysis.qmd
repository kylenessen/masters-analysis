...
create_readable_terms <- function(formula_str) {
  ...
  formatted_terms <- sapply(original_terms, function(term) {
    ...
    readable_name <- case_when(
      var_name == "total_butterflies_t_lag" ~ "roost_size",
      var_name == "max_gust" ~ "wind", 
      var_name == "temperature_avg" ~ "temp",
      var_name == "butterflies_direct_sun_t_lag" ~ "sun",
      var_name == "time_within_day_t" ~ "time",
      TRUE ~ var_name
    )
