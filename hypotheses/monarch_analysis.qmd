...
# Define comprehensive model formulas
model_formulas_30m <- list(
  # 1. Baseline Model
  "1. Baseline" = total_butterflies ~ s(abundance_t_minus_1) + s(view_id, bs = "re"),
  
  # 2. Single Environmental Factor Models
  "2a. Wind only" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(view_id, bs = "re"),
  "2b. Temperature only" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_temp) + s(view_id, bs = "re"),
  "2c. Sunlight only" = total_butterflies ~ s(abundance_t_minus_1) + s(sunlight_proportion) + s(view_id, bs = "re"),
  
  # 3. Additive Models (No Interactions)
  "3a. Wind + Temp" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(view_id, bs = "re"),
  "3b. Wind + Sunlight" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(sunlight_proportion) + s(view_id, bs = "re"),
  "3c. Temp + Sunlight" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_temp) + s(sunlight_proportion) + s(view_id, bs = "re"),
  "3d. All additive" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(sunlight_proportion) + s(view_id, bs = "re"),
  
  # 4. Single Interaction Models
  "4a. Wind x Temp interaction" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(sunlight_proportion) + ti(mean_wind_speed, mean_temp) + s(view_id, bs = "re"),
  "4b. Wind x Sunlight interaction" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(sunlight_proportion) + ti(mean_wind_speed, sunlight_proportion) + s(view_id, bs = "re"),
  "4c. Temp x Sunlight interaction" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(sunlight_proportion) + ti(mean_temp, sunlight_proportion) + s(view_id, bs = "re"),
  
  # 5. Multiple Interaction Models
  "5a. Wind x Temp + Wind x Sun" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(sunlight_proportion) + ti(mean_wind_speed, mean_temp) + ti(mean_wind_speed, sunlight_proportion) + s(view_id, bs = "re"),
  "5b. Wind x Temp + Temp x Sun" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(sunlight_proportion) + ti(mean_wind_speed, mean_temp) + ti(mean_temp, sunlight_proportion) + s(view_id, bs = "re"),
  "5c. Wind x Sun + Temp x Sun" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(sunlight_proportion) + ti(mean_wind_speed, sunlight_proportion) + ti(mean_temp, sunlight_proportion) + s(view_id, bs = "re"),
  
  # 6. Global Model with All Interactions
  "6. Global model" = total_butterflies ~ s(abundance_t_minus_1) + s(mean_wind_speed) + s(mean_temp) + s(sunlight_proportion) + ti(mean_wind_speed, mean_temp) + ti(mean_wind_speed, sunlight_proportion) + ti(mean_temp, sunlight_proportion) + s(view_id, bs = "re")
)
...
for (i in seq_along(model_formulas_30m)) {
  ...
  tryCatch({
    ...
    # Diagnostic plots - individual plots for better visibility in PDF
    cat("\n\nDiagnostic plots:\n")
    ...
    # Plot 3: Scale-Location (if appropriate)
    plot(fitted(gam_model), sqrt(abs(residuals(gam_model))), 
         xlab = "Fitted values", ylab = "√|Residuals|",
         main = "Scale-Location")
    
    # Plot 4: Response vs Fitted
    plot(fitted(gam_model), model_data$total_butterflies,
