...
m_time <- bam(total_butterflies ~ s(time_above_threshold, k = k_val) + s(day_id, bs = "re") + s(Observer, bs = "re"),
              data = df_model,
              family = tw(),
              method = "fREML",
              discrete = TRUE,
...
m_additive <- bam(total_butterflies ~ s(temperature, k = k_val) +
                                    ...
                                    s(time_above_threshold, k = k_val) +
                                    s(day_id, bs = "re") +
                                    s(Observer, bs = "re"),
                  data = df_model,
                  family = tw(),
...
```{r plot-time-threshold, fig.width=8, fig.height=6}
